...
public interface CarSqlConstants {
        ...
        String INSERT_SQL_SALE = String.format(
                        "INSERT INTO sales (carId, customerId, saleDate, carCostPrice, actualSalePrice, discountApplied, paymentMethod, saleNotes) VALUES (?, ?, ?, ?, ?, ?, ?, ?) RETURNING %s",
                        ALL_COLUMNS_SALE);
